    ...
    return (
      <Card className="bg-card/80 border-primary/20">
        <CardContent className="p-8 text-center">
          ...
          <p className="font-cairo text-sm text-muted-foreground">لا توجد برامج تبرعات حالياً</p>
        </CardContent>
      </Card>
    );
  }
    ...
    <div className="space-y-4">
      ...
      <Card className="bg-gradient-to-br from-pink-500/10 to-red-500/10 border-pink-500/20">
        <CardContent className="p-4 text-center">
          ...
          <h3 className="font-cairo text-sm font-bold mb-1">برامج المساعدات والتبرعات</h3>
          <p className="text-[10px] text-muted-foreground font-cairo">
            نسبة {totalAllocation}% من أرباح المجمع تذهب للأعمال الخيرية
          </p>
        </CardContent>
      </Card>
          ...
          <CardContent className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="p-2 rounded-lg bg-muted/30 text-center">
                ...
                <p className="text-[9px] text-muted-foreground font-cairo">تم توزيعه</p>
              </div>
              <div className="p-2 rounded-lg bg-muted/30 text-center">
                <Users className="w-4 h-4 text-primary mx-auto mb-1" />
                <p className="text-sm font-bold">{program.beneficiaries_count}</p>
                <p className="text-[9px] text-muted-foreground font-cairo">مستفيد</p>
              </div>
            </div>

            <div>
              <div className="flex justify-between text-[10px] mb-1">
                <span className="text-muted-foreground font-cairo">نسبة التخصيص</span>
