...
import { useLanguage, SUPPORTED_LANGUAGES, VISIBLE_LANGUAGES, AppLanguage } from "@/contexts/LanguageContext";
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="max-h-80 overflow-y-auto min-w-[180px]">
        {VISIBLE_LANGUAGES.map((key) => {
          const val = SUPPORTED_LANGUAGES[key];
          return (
            <DropdownMenuItem
              key={key}
