  ...
  <Link to={card.route_path || `/${card.slug}`} className="group">
    ...
    >
      {hasValidImage && (
        ...
        <div className="relative p-8 min-h-[280px] md:min-h-[320px] flex flex-col justify-end items-end text-left bg-gradient-to-t from-background/90 via-background/60 to-transparent">
          ...
          <div className="mt-4 w-12 h-0.5 bg-gradient-to-r fl from-primary to-primary/50 group-hover:w-20 transition-all duration-300 self-end/div>
        </div>
    </article>
  </Link>
  );
