                ...
                <TableBody>
                  {badges.map(badge => (
                    <TableRow key={badge.id}>
                      <TableCell>
                        <span className="text-2xl" style={{ color: badge.badge_color }}>{badge.icon_emoji}</span>
                      </TableCell>
                ...
                {grantedBadges.map((ub: any) => {
                  ...
                  return (
                    <TableRow key={ub.id}>
                      ...
                      <TableCell>
                        <Button variant="ghost" size="sm" onClick={() => handleRevoke(ub.id)} className="text-destructive text-xs">
                          سحب
                        </Button>
                      </TableCell>
                    </TableRow>
