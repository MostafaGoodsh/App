    ...
    <>
      ...
      <main>
        ...
        <section className="container mx-auto px-4 py-4 flex flex-col gap-8 max-w-lg">
          ...
          {/* Wallet Card - اشتراك مدفوع منفصل */}
          <Link to={user ? "/vault-subscription" : "/auth"} className="group">
            ...
            <div className="relative p-8 min-h-[280px] md:min-h-[320px] flex flex-col justify-end bg-gradient-to-t from-background/95 via-background/70 to-transparent">
              ...
              <p className="font-cairo text-sm md:text-base text-white/90 leading-relaxed mb-3">
                {user 
                  ? "احم بياناتك وملفاتك بأعلى مستويات الأمان"
                  : "يجب تسجيل الدخول أولاً للاشتراك"}
              </p>
              <div className="flex items-center gap-2 text-primary font-cairo text-sm font-bold">
                <span>{user ? "اشترك الآن" : "سجل الدخول"}</span>
                <span>←</span>
              </div>
              <div className="mt-4 w-12 h-0.5 bg-gradient-to-r from-primary to-primary/50 group-hover:w-20 transition-all duration-300"></div>
            </div>
