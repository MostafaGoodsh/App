            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-8">
                ...
                <p className="text-xl text-muted-foreground">
                  {getContent('stable_coin_description', t('العملة المستقرة المدعومة بالأصول المصرية'))}
                </p>
              </div>
                ...
                <Card>
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2">
                      ...
                      {getContent('stability_title', t('الاستقرار والثبات'))}
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-muted-foreground">
                      {getContent('stability_content', t('عملة مستقرة مدعومة بالأصول الحقيقية في مصر لضمان الثبات والأمان'))}
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2">
                      ...
                      {getContent('growth_title', t('النمو المستدام'))}
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-muted-foreground">
                      {getContent('growth_content', t('نموذج اقتصادي مبتكر يدعم النمو المستدام للاقتصاد المحلي'))}
                    </p>
                  </CardContent>
                </Card>
              </div>
              ...
              <Card className="mb-8">
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <CardTitle>{getContent('msr_coin_title', t('ما هو MSR Stable Coin؟'))}</CardTitle>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="bg-gradient-to-r from-primary/10 to-secondary/10 p-6 rounded-lg border border-primary/20">
                    <h3 className="font-semibold mb-3">{t("الميزات الرئيسية:")}</h3>
                    <ul className="space-y-2 text-sm text-muted-foreground">
                      <li>• {t("مدعوم بأصول حقيقية في مصر", "Backed by real assets in Egypt")}</li>
                      <li>• {t("استقرار في القيمة مقابل الجنيه المصري", "Value stability against the Egyptian pound")}</li>
                      <li>• {t("شفافية كاملة في الاحتياطيات", "Full transparency in reserves")}</li>
                      <li>• {t("سهولة في التحويل والاستخدام", "Easy conversion and usage")}</li>
                      <li>• {t("دعم للاقتصاد المحلي المصري", "Support for the local Egyptian economy")}</li>
                    </ul>
                  </div>
                  ...
                  <div className="text-center pt-6">
                    <Button disabled className="mr-2">
                      ...
                      {t("الورقة البيضاء (قريباً)")}
                    </Button>
                    <Button variant="outline" disabled>
                      {t("احصل على MSR (قريباً)")}
                    </Button>
                  </div>
                </CardContent>
              </Card>
