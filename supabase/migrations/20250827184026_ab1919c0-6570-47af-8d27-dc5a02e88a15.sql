-- Enhanced Wallet Security Implementation
...
BEGIN
  ...
  IF (v_validation_result->>'mfa_required')::BOOLEAN THEN
    ...
    -- Update access log with MFA verification
...
-- 10. Insert default security levels
INSERT INTO public.mining_levels (level_number, level_name, required_account_strength, mining_rate_per_hour, upgrade_cost)
VALUES 
  (1, 'مبتدئ', 100, 1.0000, 0),
  (2, 'متوسط', 300, 2.5000, 100),
  (3, 'متقدم', 500, 5.0000, 250),
  (4, 'خبير', 800, 10.0000, 500),
  (5, 'محترف', 1000, 20.0000, 1000)
